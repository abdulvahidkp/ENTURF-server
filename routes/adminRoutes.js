...
router.put("/users/blockStatus", verifyToken, userController.blockUserForFlutter); //for mobile

router.get("/vm", verifyToken, vmController.getVms);
router.put("/vm/blockStatus/:_id", vmController.blockVm);
router.put("/vm/blockStatus", verifyToken, vmController.blockVmForFlutter); //for mobile
